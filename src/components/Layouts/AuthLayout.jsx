...
const AuthLayout = ({ children, variant = "signup" }) => {
  return (
    <div className="min-h-screen bg-[#f3f4f6] p-2 md:p-3">
      <div className="mx-auto grid min-h-[96vh] w-full max-w-[1450px] overflow-hidden rounded-[28px] border border-[#e5e7eb] bg-white lg:grid-cols-[1.08fr_0.92fr]">
